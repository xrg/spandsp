 ...
 *
 * $Id: t30.h,v 1.4 2004/03/25 13:28:37 steveu Exp $
 */
...
*/
typedef void (phase_b_handler_t)(t30_state_t *s, void *user_data, int result);
/*!
...
*/
typedef void (phase_d_handler_t)(t30_state_t *s, void *user_data, int result);
/*!
...
*/
typedef void (phase_e_handler_t)(t30_state_t *s, void *user_data, int result);
...
struct t30_state_s
{
    ...
    /*! \brief A pointer to a callback routine to be called when phase B events
        occur. */
    phase_b_handler_t *phase_b_handler;
    ...
    /*! \brief A pointer to a callback routine to be called when phase D events
        occur. */
    phase_d_handler_t *phase_d_handler;
    ...
    /*! \brief A pointer to a callback routine to be called when phase E events
        occur. */
    phase_e_handler_t *phase_e_handler;
...
*/
void t30_decode_dis_dtc_dcs(t30_state_t *s, uint8_t *dis, int len);
